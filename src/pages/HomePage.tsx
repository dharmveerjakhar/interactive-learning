    ...
    <div>
      <div className="text-center mb-12">
        <h1 className="text-4xl font-bold text-gray-900 mb-4">
          Master Machine Coding for Interviews
        </h1>
        <p className="text-xl text-gray-600 max-w-3xl mx-auto">
          Learn everything you need for machine coding interviews - from OOP fundamentals to design patterns and practice problems
        </p>
      </div>
